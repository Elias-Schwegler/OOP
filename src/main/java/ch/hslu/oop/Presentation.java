...
import ch.hslu.oop.sw03.Point;
import ch.hslu.oop.sw03.Sw03Demo;
...
public class Presentation {
    ...
    private static void runSw10() {
        ...
        ch.hslu.oop.sw10.Sw10Demo.main(new String[]{});
        System.out.println("\n>>> SW10 END <<<\n");
    }
    ...
    private static void runSw04() {
        ...
        ch.hslu.oop.sw04.Fahrzeug auto = new ch.hslu.oop.sw04.Fahrzeug();
        ...
        ch.hslu.oop.sw04.Line line = new ch.hslu.oop.sw04.Line(0, 0, 10, 10);
        System.out.println("Urspruengliche " + line);

        ch.hslu.oop.sw03.Point startPoint = line.getStartPoint();
    ...
    private static void runSw08() {
        ...
        ch.hslu.oop.sw08.Sw08TestReview review = new ch.hslu.oop.sw08.Sw08TestReview();
    ...
    private static void runSw09() {
        ...
        ch.hslu.oop.sw09.Sw09Demo demo = new ch.hslu.oop.sw09.Sw09Demo();
