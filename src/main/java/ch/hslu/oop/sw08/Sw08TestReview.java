...
public class Sw08TestReview {
    ...
    public void demoDoWhile() {
        ...
        // (Hinweis: javac verbietet `while (false)` direkt -> "unreachable statement",
        //  darum ueber boolean-Variable, demonstriert aber dieselbe Semantik.)
        count = 0;
        boolean bedingung = false;
        while (bedingung) {
            count++; // Wird zur Laufzeit nie ausgefuehrt.
        }
